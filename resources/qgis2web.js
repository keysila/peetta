...
map.getView().fit([12105981.138578, -849092.924774, 12110176.252754, -846685.204467], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">PETA DESA PATIMUAN</h2>';
        return titleElement;
    })(),
